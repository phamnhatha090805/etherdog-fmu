# EtherDOG-FMU
**EtherDOG** (**EtherCAT** **D**ynamic **O**bject **G**enerator) is a software-defined EtherCAT device platform designed for scalable and flexible simulation of virtual EtherCAT networks.
